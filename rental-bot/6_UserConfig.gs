...
// ─── 縣市名稱 → 591 region 代碼 ──────────────────────────────
// ⚠️ 對照表為公開資料整理，若比對結果跟實際搜尋不符，
//    請直接到 591 網站選好縣市後，從網址列的 region= 參數取得正確代碼並修改此表。
const REGION_MAP = {
  "台北市": 1, "新北市": 3, "基隆市": 2, "桃園市": 6, "新竹市": 4, "新竹縣": 5,
  "苗栗縣": 8, "台中市": 7, "彰化縣": 10, "南投縣": 11, "雲林縣": 12,
  "嘉義市": 13, "嘉義縣": 14, "台南市": 15, "高雄市": 17, "屏東縣": 16,
  "宜蘭縣": 9, "花蓮縣": 18, "台東縣": 19, "澎湖縣": 20, "金門縣": 21, "連江縣": 22
};
